...
public abstract class OverScrollBounceEffectDecoratorBase implements IOverScrollDecor, View.OnTouchListener {
    ...
    protected class BounceBackState implements IDecoratorState, Animator.AnimatorListener, ValueAnimator.AnimatorUpdateListener {
        ...
        protected final Interpolator newInterpolator = new AnimUtil.CustomDampingInterpolator();
        ...
        protected Animator createAnimator() {
            ...
            return wholeAnim;
            //ObjectAnimator newAnim = createNewAnimator(slowdownEndOffset);
            //return newAnim;
        }
        ...
        protected ObjectAnimator createNewAnimator(float startOffset) {
            ...
            float bounceBackDuration = (Math.abs(startOffset) / mAnimAttributes.mMaxOffset) * MAX_BOUNCE_BACK_DURATION_MS;
            ObjectAnimator bounceBackAnim = ObjectAnimator.ofFloat(view, mAnimAttributes.mProperty, mStartAttr.mAbsOffset);
            bounceBackAnim.setDuration(Math.max((int) bounceBackDuration, MIN_BOUNCE_BACK_DURATION_MS)+500);
            bounceBackAnim.setInterpolator(newInterpolator);
            bounceBackAnim.addUpdateListener(this);
            return bounceBackAnim;
        }
    }
